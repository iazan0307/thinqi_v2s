...
-- Addendum: campos para redefinição de senha
-- Execute este bloco se o banco já foi criado com a migration anterior
ALTER TABLE "usuarios" ADD COLUMN IF NOT EXISTS "reset_token_hash" TEXT;
ALTER TABLE "usuarios" ADD COLUMN IF NOT EXISTS "reset_token_expires" TIMESTAMP(3);
